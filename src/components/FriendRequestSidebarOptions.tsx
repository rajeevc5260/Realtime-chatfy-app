...
const FriendRequestSidebarOptions: FC<FriendRequestSidebarOptionsProps> = ({
  ...
  return (
    <Link
      ...
      <div className='text-gray-400 border-gray-200 group-hover:border-blue-600 group-hover:text-blue-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white'>
